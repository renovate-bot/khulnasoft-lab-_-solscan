...
from solscan.printers.guidance.echidna import Echidna
...
def generate_output(sl: Solscan) -> Dict[str, Dict[str, str]]:
    output = {}
...
class TestASTParsing:
    ...
    def test_parsing(self, test_file, version, flavor):
        ...
        sl = Solscan(cc, solc_force_legacy_json=flavor == "legacy", disallow_partial=True)
