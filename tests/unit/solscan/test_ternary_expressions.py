...
from solscan.slithir.operations import Assignment
from solscan.core.expressions import AssignmentOperation, TupleExpression
...
def test_ternary_conversions(solc_binary_path) -> None:
    ...
    solscan = Solscan(Path(TEST_DATA_DIR, "ternary_expressions.sol").as_posix(), solc=solc_path)
