...
from solscan.core import expressions
...
from solscan.core.expressions.binary_operation import BinaryOperation
from solscan.core.expressions.expression import Expression
from solscan.core.expressions.index_access import IndexAccess
from solscan.core.expressions.literal import Literal
from solscan.core.expressions.new_array import NewArray
from solscan.core.expressions.new_contract import NewContract
from solscan.core.expressions.tuple_expression import TupleExpression
from solscan.core.expressions.unary_operation import UnaryOperation
from solscan.core.solidity_types import ArrayType, ElementaryType, TypeAlias, UserDefinedType
...
from solscan.slithir.tmp_operations.argument import Argument
...
from solscan.visitors.expression.expression import ExpressionVisitor
...
class ExpressionToSlithIR(ExpressionVisitor):
    ...
    def __init__(self, expression: Expression, node: "Node") -> None:
        from solscan.core.cfg.node import NodeType  # pylint: disable=import-outside-toplevel
