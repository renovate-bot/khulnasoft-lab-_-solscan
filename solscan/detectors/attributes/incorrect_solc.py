...
from solscan.formatters.attributes.incorrect_solc import custom_format
...
class IncorrectSolc(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#incorrect-versions-of-solidity"
