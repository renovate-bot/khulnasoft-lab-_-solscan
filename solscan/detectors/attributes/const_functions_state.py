...
class ConstantFunctionsState(AbstractDetector):
    ...
    ARGUMENT = "constant-function-state"  # run the detector with solscan.py --ARGUMENT
    HELP = "Constant functions changing the state"  # help information
    IMPACT = DetectorClassification.MEDIUM
    CONFIDENCE = DetectorClassification.MEDIUM

    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#constant-functions-changing-the-state"
