...
from solscan.formatters.attributes.const_functions import custom_format
...
class ConstantFunctionsAsm(AbstractDetector):
    ...
    ARGUMENT = "constant-function-asm"  # run the detector with solscan.py --ARGUMENT
    HELP = "Constant functions using assembly code"  # help information
    IMPACT = DetectorClassification.MEDIUM
    CONFIDENCE = DetectorClassification.MEDIUM

    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#constant-functions-using-assembly-code"
...
All the calls to `get` revert, breaking Bob's smart contract execution."""
    ...
    @staticmethod
    def _format(comilation_unit: SolscanCompilationUnit, result: Dict) -> None:
