...
from solscan.core.declarations import Contract, SolidityFunction
...
class LockedEther(AbstractDetector):  # pylint: disable=too-many-nested-blocks
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#contracts-that-lock-ether"
