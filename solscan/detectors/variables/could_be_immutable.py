...
from solscan.formatters.variables.unchanged_state_variables import custom_format
...
class CouldBeImmutable(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#state-variables-that-could-be-declared-immutable"
