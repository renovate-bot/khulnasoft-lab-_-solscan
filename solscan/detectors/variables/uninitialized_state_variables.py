...
from solscan.slithir.operations import InternalCall, LibraryCall
...
class UninitializedStateVarsDetection(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#uninitialized-state-variables"
