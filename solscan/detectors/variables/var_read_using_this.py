...
from solscan.core.declarations import Function, SolidityVariable
...
class VarReadUsingThis(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#public-variable-read-in-external-context"
