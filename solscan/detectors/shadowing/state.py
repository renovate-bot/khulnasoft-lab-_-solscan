...
from solscan.detectors.shadowing.common import is_upgradable_gap_variable
...
class StateShadowing(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#state-variable-shadowing"
