...
from solscan.formatters.exceptions import FormatImpossible
from solscan.formatters.utils.patches import apply_patch, create_diff
from solscan.utils.colors import green, yellow, red
from solscan.utils.comparable_enum import ComparableEnum
from solscan.utils.output import Output, SupportedOutput
...
class AbstractDetector(metaclass=abc.ABCMeta):
    ARGUMENT = ""  # run the detector with solscan.py --ARGUMENT
        ...
        if results and self.solscan.triage_mode:
            while True:
                ...
                try:
                    ...
                    self.solscan.save_results_to_hide(
    ...
    def generate_result(
        ...
        output = Output(
            ...
            markdown_root=self.solscan.markdown_root,
        )
    ...
    @staticmethod
    def _format(_compilation_unit: SolscanCompilationUnit, _result: Dict) -> None:
        """Implement format"""
        return
