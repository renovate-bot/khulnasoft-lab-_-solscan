...
from solscan.core.solidity_types import UserDefinedType
...
from solscan.core.declarations.solidity_variables import SolidityFunction
from solscan.slithir.operations import EventCall
from solscan.slithir.operations import HighLevelCall
...
class ABIEncoderV2Array(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#storage-abiencoderv2-array"
    )
