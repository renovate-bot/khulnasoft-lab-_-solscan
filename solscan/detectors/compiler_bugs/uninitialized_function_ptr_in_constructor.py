...
from solscan.slithir.operations import InternalDynamicCall, OperationWithLValue
...
class UninitializedFunctionPtrsConstructor(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#uninitialized-function-pointers-in-constructors"
