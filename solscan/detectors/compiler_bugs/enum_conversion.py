...
from solscan.slithir.operations import TypeConversion
...
class EnumConversion(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#dangerous-enum-conversion"
