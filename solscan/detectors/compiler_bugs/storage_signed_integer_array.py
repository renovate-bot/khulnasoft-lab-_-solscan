...
from solscan.core.cfg.node import NodeType, Node
from solscan.core.solidity_types import ArrayType
from solscan.core.solidity_types.elementary_type import Int, ElementaryType
...
from solscan.slithir.operations import Operation, OperationWithLValue
from solscan.slithir.operations.assignment import Assignment
from solscan.slithir.operations.init_array import InitArray
...
class StorageSignedIntegerArray(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#storage-signed-integer-array"
    )
