...
def _find_missing_inheritance(compilation_unit: SolscanCompilationUnit) -> List[Contract]:
    """
...
class NameReused(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#name-reused"
...
"""
    ...
    def _detect(self) -> List[Output]:
        ...
        for b in most_base_with_missing_inheritance:
            ...
            if b.inheritance:
                info += ["\t- Solscan could not determine which contract has a duplicate name:\n"]
