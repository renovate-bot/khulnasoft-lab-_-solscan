...
from solscan.formatters.naming_convention.naming_convention import custom_format
...
class NamingConvention(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions"
