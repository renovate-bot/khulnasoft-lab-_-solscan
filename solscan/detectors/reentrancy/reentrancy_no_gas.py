...
from solscan.detectors.abstract_detector import DetectorClassification
from solscan.detectors.reentrancy.reentrancy import Reentrancy, to_hashable
from solscan.slithir.operations import Send, Transfer, EventCall
from solscan.slithir.operations.high_level_call import HighLevelCall
from solscan.slithir.operations.member import Member
from solscan.slithir.operations.return_operation import Return
...
class ReentrancyNoGas(Reentrancy):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#reentrancy-vulnerabilities-4"
    )
