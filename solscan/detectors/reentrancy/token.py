...
from solscan.core.declarations import Function, Contract, SolidityVariableComposed
from solscan.detectors.abstract_detector import (
    AbstractDetector,
    DetectorClassification,
    DETECTOR_INFO,
)
from solscan.slithir.operations import LowLevelCall, HighLevelCall
...
class TokenReentrancy(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#token-reentrant"
