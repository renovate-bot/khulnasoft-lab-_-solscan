...
class RightToLeftOverride(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#right-to-left-override-character"
...
"""
    ...
    def _detect(self) -> List[Output]:
        ...
        for filename, source in self.solscan.source_code.items():
            ...
            while True:
                ...
                relative = self.solscan.crytic_compile.filename_lookup(filename).relative
