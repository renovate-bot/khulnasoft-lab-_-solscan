...
from solscan.analyses.data_dependency.data_dependency import is_tainted, is_dependent
...
class ArbitrarySendEth(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#functions-that-send-ether-to-arbitrary-destinations"
