...
from solscan.core.declarations import Function, FunctionContract, Contract
...
from solscan.formatters.functions.external_function import custom_format
from solscan.slithir.operations import InternalCall, InternalDynamicCall
from solscan.slithir.operations import SolidityCall
...
class ExternalFunction(AbstractDetector):
    ...
    https://github.com/khulnasoft-lab/solscan/pull/53#issuecomment-432809950
    """
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#public-function-that-could-be-declared-external"
