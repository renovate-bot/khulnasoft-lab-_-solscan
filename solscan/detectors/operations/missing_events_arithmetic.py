...
from solscan.core.solidity_types.elementary_type import ElementaryType, Int, Uint
...
from solscan.slithir.operations.event_call import EventCall
...
class MissingEventsArithmetic(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#missing-events-arithmetic"
