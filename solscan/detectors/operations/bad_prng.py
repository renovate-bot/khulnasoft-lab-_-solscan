...
from solscan.slithir.operations import BinaryType, Binary
from solscan.slithir.operations import SolidityCall
from solscan.utils.output import Output, AllSupportedOutput
...
class BadPRNG(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#weak-PRNG"
