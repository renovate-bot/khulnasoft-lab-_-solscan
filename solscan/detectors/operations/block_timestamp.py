...
from solscan.core.declarations import Function, Contract, FunctionContract
...
from solscan.slithir.operations import Binary, BinaryType
...
class Timestamp(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#block-timestamp"
