...
from solscan.core.expressions import BinaryOperation, Identifier, MemberAccess, UnaryOperation
from solscan.core.solidity_types import ArrayType
from solscan.core.variables import StateVariable
from solscan.detectors.abstract_detector import AbstractDetector, DetectorClassification
from solscan.slithir.operations import Length, Delete, HighLevelCall
...
class CacheArrayLength(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#cache-array-length"
