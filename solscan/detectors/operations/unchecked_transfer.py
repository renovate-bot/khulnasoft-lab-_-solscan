...
from solscan.detectors.operations.unused_return_values import UnusedReturnValues
...
class UncheckedTransfer(UnusedReturnValues):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#unchecked-transfer"
