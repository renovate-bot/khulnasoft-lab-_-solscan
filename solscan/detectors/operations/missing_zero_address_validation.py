...
from solscan.core.declarations.function import ModifierStatements
...
from solscan.slithir.operations import Send, Transfer, LowLevelCall
...
class MissingZeroAddressValidation(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#missing-zero-address-validation"
