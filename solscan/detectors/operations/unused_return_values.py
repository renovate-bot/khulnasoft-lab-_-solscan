...
from solscan.slithir.operations import HighLevelCall, Assignment, Unpack, Operation
...
class UnusedReturnValues(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#unused-return"
