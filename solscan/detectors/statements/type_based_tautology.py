...
from solscan.core.solidity_types.elementary_type import Int, Uint
...
class TypeBasedTautology(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#tautology-or-contradiction"
    )
