...
from solscan.slithir.operations import InternalCall, OperationWithLValue
...
class CostlyOperationsInLoop(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#costly-operations-inside-a-loop"
