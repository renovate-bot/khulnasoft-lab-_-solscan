...
from solscan.slithir.operations import Binary, Assignment, BinaryType, LibraryCall, Operation
...
class DivideBeforeMultiply(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#divide-before-multiply"
