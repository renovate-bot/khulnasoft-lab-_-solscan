...
from solscan.slithir.variables import ReferenceVariable, TemporaryVariable, TupleVariable
...
class WriteAfterWrite(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#write-after-write"
