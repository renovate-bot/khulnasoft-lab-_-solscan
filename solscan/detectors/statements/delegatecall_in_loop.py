...
from solscan.slithir.operations import LowLevelCall, InternalCall
...
class DelegatecallInLoop(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation/#payable-functions-using-delegatecall-inside-a-loop"
