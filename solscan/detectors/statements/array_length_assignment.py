...
from solscan.slithir.operations import Assignment, Length
from solscan.slithir.variables.reference import ReferenceVariable
from solscan.slithir.operations.binary import Binary
from solscan.analyses.data_dependency.data_dependency import is_tainted
...
class ArrayLengthAssignment(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#array-length-assignment"
