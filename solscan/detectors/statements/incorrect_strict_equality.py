...
from solscan.analyses.data_dependency.data_dependency import is_dependent_ssa
...
from solscan.core.solidity_types import MappingType, ElementaryType
...
from solscan.utils.type import is_underlying_type_address
...
class IncorrectStrictEquality(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#dangerous-strict-equalities"
    )
