...
from solscan.core.expressions.unary_operation import UnaryOperationType, UnaryOperation
...
class IncorrectUnaryExpressionDetection(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#dangerous-unary-expressions"
    )
