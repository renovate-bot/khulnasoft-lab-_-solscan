...
from solscan.core.declarations import Contract, Structure, Enum
...
from solscan.core.solidity_types.elementary_type import Uint, Int, Byte
...
class IncorrectUsingFor(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#incorrect-using-for-usage"
