...
from solscan.slithir.operations import LowLevelCall, SolidityCall
...
class UnprotectedUpgradeable(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation#unprotected-upgradeable-contract"
