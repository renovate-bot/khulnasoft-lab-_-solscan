...
from solscan.core.declarations import SolidityVariableComposed, Contract
...
class MsgValueInLoop(AbstractDetector):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Detector-Documentation/#msgvalue-inside-a-loop"
