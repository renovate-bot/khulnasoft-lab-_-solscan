...
from solscan.core.declarations.contract import Contract, USING_FOR_KEY
...
from solscan.core.solidity_types import ElementaryType, TypeAliasContract
...
from solscan.solc_parsing.declarations.event import EventSolc
from solscan.solc_parsing.declarations.function import FunctionSolc
from solscan.solc_parsing.declarations.modifier import ModifierSolc
from solscan.solc_parsing.declarations.structure_contract import StructureContractSolc
from solscan.solc_parsing.exceptions import ParsingError, VariableNotFound
from solscan.solc_parsing.solidity_types.type_parsing import parse_type
from solscan.solc_parsing.variables.state_variable import StateVariableSolc
...
class ContractSolc(CallerContextExpression):
    def __init__(
        self, solscan_parser: "SolscanCompilationUnitSolc", contract: Contract, data: Dict[str, Any]
    ) -> None:
        # assert solscanSolc.solc_version.startswith('0.4')
    ...
    def _parse_custom_error(self, custom_error: Dict) -> None:
        ...
        ce_parser = CustomErrorSolc(ce, custom_error, self._solscan_parser)
    ...
    def _parse_modifier(self, modifier_data: Dict) -> None:
        ...
        modif_parser = ModifierSolc(modif, modifier_data, self, self.solscan_parser)  # type: ignore
        ...
        self._solscan_parser.add_function_or_modifier_parser(modif_parser)
    ...
    def _parse_function(self, function_data: Dict) -> None:
        ...
        func_parser = FunctionSolc(func, function_data, self, self._solscan_parser)  # type: ignore
        ...
        self._solscan_parser.add_function_or_modifier_parser(func_parser)
    ...
    def _analyze_params_element(  # pylint: disable=too-many-arguments
        ...
        elem_parser = Cls_parser(
            elem, element_parser.function_not_parsed, self, self.solscan_parser
        )
        if (
        ...
        self._solscan_parser.add_function_or_modifier_parser(elem_parser)
    ...
    def _analyze_params_elements(  # pylint: disable=too-many-arguments,too-many-locals
        ...
        try:
            for father in self._contract.inheritance:
                father_parser = self._solscan_parser.underlying_contract_to_parser[father]
    ...
    def _handle_comment(self, attributes: Dict) -> None:
        ...
        And handle custom solscan comments
