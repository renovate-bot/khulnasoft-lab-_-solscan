...
from solscan.core.cfg.node import NodeType, link_nodes, insert_node, Node
from solscan.core.cfg.scope import Scope
from solscan.core.declarations.contract import Contract
from solscan.core.declarations.function import (
    Function,
    ModifierStatements,
    FunctionType,
)
from solscan.core.declarations.function_contract import FunctionContract
from solscan.core.expressions import AssignmentOperation
from solscan.core.source_mapping.source_mapping import Source
from solscan.core.variables.local_variable import LocalVariable
from solscan.core.variables.local_variable_init_from_tuple import LocalVariableInitFromTuple
from solscan.solc_parsing.cfg.node import NodeSolc
...
from solscan.solc_parsing.variables.local_variable import LocalVariableSolc
from solscan.solc_parsing.variables.local_variable_init_from_tuple import (
    LocalVariableInitFromTupleSolc,
)
from solscan.solc_parsing.variables.variable_declaration import MultipleVariablesDeclaration
from solscan.utils.expression_manipulations import SplitTernaryExpression
from solscan.visitors.expression.export_values import ExportValues
from solscan.visitors.expression.has_conditional import HasConditional
from solscan.solc_parsing.yul.parse_yul import YulBlock
...
class FunctionSolc(CallerContextExpression):
    ...
    def __init__(
        ...
        self._solscan_parser: "SolscanCompilationUnitSolc" = solscan_parser
    ...
    def _parse_try_catch(self, statement: Dict, node: NodeSolc, scope: Scope) -> NodeSolc:
        ...
        if externalCall is None:
            raise ParsingError(f"Try/Catch not correctly parsed by Solscan {statement}")
    ...
    def _parse_catch(
        ...
        if block is None:
            raise ParsingError(f"Catch not correctly parsed by Solscan {statement}")
