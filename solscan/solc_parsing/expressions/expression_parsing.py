...
import solscan.core.expressions.type_conversion
...
from solscan.core.expressions.assignment_operation import (
    AssignmentOperation,
    AssignmentOperationType,
)
from solscan.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
...
from solscan.solc_parsing.expressions.find_variable import find_variable
from solscan.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
...
def parse_call(
    ...
    solscan.core.expressions.call_expression.CallExpression,
    solscan.core.expressions.type_conversion.TypeConversion,
]:
    src = expression["src"]
...
def parse_expression(expression: Dict, caller_context: CallerContextExpression) -> "Expression":
    ...
    if name == "NewExpression":
        ...
        if is_compact_ast:
            ...
            # see https://github.com/khulnasoft-lab/solscan/issues/794
