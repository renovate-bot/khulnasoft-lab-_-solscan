from solscan.core.declarations.solidity_variables import SOLIDITY_FUNCTIONS
from solscan.core.expressions import BinaryOperationType, UnaryOperationType
