...
from solscan.core.declarations.function import SolidityFunction
...
class PrinterWhenNotPaused(AbstractPrinter):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Printer-documentation#when-not-paused"
