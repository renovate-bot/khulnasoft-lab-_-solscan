...
from solscan.analyses.data_dependency.data_dependency import get_dependencies, SUPPORTED_TYPES
from solscan.slithir.variables import TemporaryVariable, ReferenceVariable
...
class DataDependency(AbstractPrinter):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Printer-documentation#data-dependencies"
