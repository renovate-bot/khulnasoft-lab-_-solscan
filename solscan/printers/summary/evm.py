...
from solscan.analyses.evm import (
    generate_source_to_evm_ins_mapping,
    load_evm_cfg_builder,
)
from solscan.utils.colors import blue, green, magenta, red


def _extract_evm_info(solscan):
    """
...
class PrinterEVM(AbstractPrinter):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Printer-documentation#evm"
