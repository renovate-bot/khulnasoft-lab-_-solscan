...
class PrinterCallGraph(AbstractPrinter):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Printer-documentation#call-graph"
    ...
    def output(self, filename: str) -> Output:
        ...
        with open(all_contracts_filename, "w", encoding="utf8") as f:
            ...
            all_functionss = [
                compilation_unit.functions for compilation_unit in self.solscan.compilation_units
            ]
        ...
        for derived_contract in self.solscan.contracts_derived:
