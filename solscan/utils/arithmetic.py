...
from solscan.utils.integer_conversion import convert_string_to_fraction
...
def convert_subdenomination(
    ...
    raise SolscanException(f"Subdemonination conversion impossible {decimal_value} {sub}")
...
def _unchecked_arithemtic_usage(function: "Function") -> bool:
    ...
    from solscan.slithir.operations import Binary
