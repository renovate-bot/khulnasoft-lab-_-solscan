...
from solscan.utils.type import (
...
from solscan.core.declarations import Structure, Enum, Contract

if TYPE_CHECKING:
    from solscan.core.declarations import FunctionContract, CustomErrorContract
