...
from solscan.detectors.abstract_detector import classification_txt, AbstractDetector
from solscan.printers.abstract_printer import AbstractPrinter
from solscan.utils.colors import yellow, red
...
def read_config_file(args: argparse.Namespace) -> None:
    ...
    if args.config_file is None:
        ...
        if os.path.exists("solscan.config.json"):
            # The default file exists, use it
            args.config_file = "solscan.config.json"
        else:
            return
