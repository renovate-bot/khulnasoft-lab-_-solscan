...
from solscan.all_exceptions import SolscanException
from solscan.core.expressions import UnaryOperation
from solscan.core.expressions.assignment_operation import AssignmentOperation
...
from solscan.core.expressions.conditional_expression import ConditionalExpression
from solscan.core.expressions.elementary_type_name_expression import ElementaryTypeNameExpression
...
from solscan.core.expressions.type_conversion import TypeConversion
from solscan.core.expressions.new_elementary_type import NewElementaryType
...
class SplitTernaryExpression:
    ...
    def copy_expression(
        ...
        if isinstance(expression, ConditionalExpression):
            raise SolscanException("Nested ternary operator not handled")
