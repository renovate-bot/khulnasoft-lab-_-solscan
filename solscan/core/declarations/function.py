...
from solscan.core.cfg.scope import Scope
from solscan.core.declarations.solidity_variables import (
    SolidityFunction,
    SolidityVariable,
    SolidityVariableComposed,
)
from solscan.core.expressions import (
    Identifier,
    IndexAccess,
    MemberAccess,
    UnaryOperation,
...
from solscan.utils.type import convert_type_for_solidity_signature_to_string
...
if TYPE_CHECKING:
    from solscan.utils.type_helpers import (
        InternalCallType,
        LowLevelCallType,
        HighLevelCallType,
        LibraryCallType,
    ...
    from solscan.slithir.variables.variable import SlithIRVariable
    from solscan.slithir.variables import LocalIRVariable
...
class Function(SourceMapping, metaclass=ABCMeta):  # pylint: disable=too-many-public-methods
    ...
    def __init__(self, compilation_unit: "SolscanCompilationUnit") -> None:
        ...
        self.compilation_unit: "SolscanCompilationUnit" = compilation_unit
    ...
    def name(self) -> str:
        ...
        if self._function_type == FunctionType.CONSTRUCTOR_VARIABLES:
            return "solscanConstructorVariables"
        if self._function_type == FunctionType.CONSTRUCTOR_CONSTANT_VARIABLES:
            return "solscanConstructorConstantVariables"
        return self._name
    ...
    def can_reenter(self, callstack: Optional[List[Union["Function", "Variable"]]] = None) -> bool:
        ...
        :return bool:
        """
        from solscan.slithir.operations import Call
    ...
    def is_constructor_variables(self) -> bool:
        ...
        Solscan has inbuilt functions to hold the state variables initialization
        """
    ...
    def return_values(self) -> List["SlithIRVariable"]:
        ...
        """
        from solscan.core.cfg.node import NodeType
        from solscan.slithir.operations import Return
    ...
    def _solidity_variable_in_internal_calls(node: "Node") -> List[SolidityVariable]:
        from solscan.slithir.operations.internal_call import InternalCall
    ...
    def _get_last_ssa_variable_instances(
        ...
        from solscan.slithir.variables import ReferenceVariable
        from solscan.slithir.operations import OperationWithLValue
        from solscan.core.cfg.node import NodeType
    ...
    def _unchange_phi(ir: "Operation") -> bool:
        from solscan.slithir.operations import Phi, PhiCallback
    ...
    def fix_phi(
        ...
        from solscan.slithir.operations import InternalCall, PhiCallback
        from solscan.slithir.variables import Constant, StateIRVariable
