...
from solscan.core.declarations.function import Function, FunctionType, FunctionLanguage
from solscan.utils.erc import (
    ERC20_signatures,
    ERC165_signatures,
    ERC223_signatures,
    ERC721_signatures,
...
from solscan.utils.tests_pattern import is_test_contract

# pylint: disable=too-many-lines,too-many-instance-attributes,import-outside-toplevel,too-many-nested-blocks
if TYPE_CHECKING:
    from solscan.utils.type_helpers import LibraryCallType, HighLevelCallType, InternalCallType
    ...
    from solscan.core.variables import Variable, StateVariable
...
class Contract(SourceMapping):  # pylint: disable=too-many-public-methods
    ...
    def is_upgradeable_proxy(self) -> bool:
        ...
        from solscan.slithir.operations import LowLevelCall
    ...
    def is_incorrectly_constructed(self) -> bool:
        """
        Return true if there was an internal Solscan's issue when analyzing the contract
        :return:
        """
    ...
    def convert_expression_to_slithir_ssa(self) -> None:
        ...
        :return:
        """
        from solscan.slithir.variables import StateIRVariable
