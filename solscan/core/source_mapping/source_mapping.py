...
def _compute_line(
    compilation_unit: "SolscanCompilationUnit", filename: Filename, start: int, length: int
...
def _convert_source_mapping(
    offset: str, compilation_unit: "SolscanCompilationUnit"
...
class SourceMapping(Context, metaclass=ABCMeta):
    ...
    def set_offset(
        self, offset: Union["Source", str], compilation_unit: "SolscanCompilationUnit"
    ) -> None:
    ...
    def add_reference_from_raw_source(
        self, offset: str, compilation_unit: "SolscanCompilationUnit"
    ) -> None:
