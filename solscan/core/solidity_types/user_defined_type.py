...
class UserDefinedType(Type):
    ...
    def storage_size(self) -> Tuple[int, bool]:
        ...
        if isinstance(self._type, Structure):
            # todo there's some duplicate logic here and solscan_core, can we refactor this?
            slot = 0
            offset = 0
        ...
        raise SolscanException(to_log)

    def __str__(self) -> str:
        from solscan.core.declarations.structure_contract import StructureContract
        from solscan.core.declarations.enum_contract import EnumContract
