...
from solscan.core.solidity_types.type_alias import TypeAliasTopLevel
...
class SolscanCompilationUnit(Context):
    def __init__(self, core: "SolscanCore", crytic_compilation_unit: CompilationUnit) -> None:
        super().__init__()
