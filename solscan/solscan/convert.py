...
from solscan.core.declarations.solidity_import_placeholder import SolidityImportPlaceHolder
from solscan.core.declarations.solidity_variables import SolidityCustomRevert
from solscan.core.expressions import Identifier, Literal
from solscan.core.expressions.expression import Expression
from solscan.core.solidity_types import (
    ArrayType,
    ElementaryType,
    FunctionType,
    MappingType,
...
from solscan.core.solidity_types.type_alias import TypeAliasTopLevel, TypeAlias
...
from solscan.slithir.operations.codesize import CodeSize
from solscan.slithir.tmp_operations.argument import Argument, ArgumentType
from solscan.slithir.tmp_operations.tmp_call import TmpCall
...
from solscan.slithir.tmp_operations.tmp_new_elementary_type import TmpNewElementaryType
from solscan.slithir.tmp_operations.tmp_new_structure import TmpNewStructure
from solscan.slithir.variables import Constant, ReferenceVariable, TemporaryVariable
from solscan.slithir.variables import TupleVariable
from solscan.utils.function import get_function_id
from solscan.utils.type import export_nested_types_from_variable
from solscan.visitors.slithir.expression_to_slithir import ExpressionToSlithIR
...
def convert_expression(expression: Expression, node: "Node") -> List[Operation]:
    ...
    # such as return true;
    from solscan.core.cfg.node import NodeType
...
def extract_tmp_call(ins: TmpCall, contract: Optional[Contract]) -> Union[Call, Nop]:
    ...
    if isinstance(ins.ori, Member):
        ...
        if isinstance(ins.ori.variable_left, Function):
            ...
            #     }
            # }
            to_log = "Solscan does not support dynamic functions to libraries if functions have the same name"
...
def convert_to_solidity_func(
    ...
    # abi.decode(a, (uint))
        ...
        # See https://github.com/khulnasoft-lab/solscan/issues/566 for potential solutions
