...
import solscan.slithir.variables.tuple_ssa
...
from solscan.core.declarations.modifier import Modifier
...
def add_ssa_ir(
    ...
    all_state_variables_instances: Dict[
        str, solscan.slithir.variables.state_variable.StateIRVariable
    ],
) -> None:
    """
