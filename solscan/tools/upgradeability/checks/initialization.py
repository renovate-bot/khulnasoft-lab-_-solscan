...
from solscan.slithir.operations import InternalCall
from solscan.tools.upgradeability.checks.abstract_checks import (
    AbstractCheck,
    CheckClassification,
)
from solscan.utils.colors import red

logger = logging.getLogger("Solscan-check-upgradeability")
...
class InitializablePresent(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initializable-is-missing"
...
class InitializableInherited(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initializable-is-not-inherited"
...
class InitializableInitializer(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initializer-is-missing"
...
class MissingInitializerModifier(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initializer-is-not-called"
...
class MissingCalls(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initialize-functions-are-not-called"
...
class MultipleCalls(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initialize-functions-are-called-multiple-times"
...
class InitializeTarget(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#initialize-function"
