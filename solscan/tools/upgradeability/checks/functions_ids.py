...
def _get_function_or_variable(contract, signature):
    ...
    raise SolscanError(f"Function id checks: {signature} not found in {contract.name}")
...
class IDCollision(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#functions-ids-collisions"
...
class FunctionShadowing(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#functions-shadowing"
