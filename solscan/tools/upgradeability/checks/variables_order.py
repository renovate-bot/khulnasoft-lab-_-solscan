...
from solscan.utils.upgradeability import get_missing_vars
...
class MissingVariable(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#missing-variables"
...
class DifferentVariableContractProxy(AbstractCheck):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#incorrect-variables-with-the-proxy"
...
class DifferentVariableContractNewContract(DifferentVariableContractProxy):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#incorrect-variables-with-the-v2"
...
class ExtraVariablesProxy(AbstractCheck):
    ...
    WIKI = (
        "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#extra-variables-in-the-proxy"
    )
...
class ExtraVariablesNewContract(ExtraVariablesProxy):
    ...
    WIKI = "https://github.com/khulnasoft-lab/solscan/wiki/Upgradeability-Checks#extra-variables-in-the-v2"
