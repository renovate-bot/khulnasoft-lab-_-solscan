...
from solscan.core.declarations import Contract, Structure
from solscan.core.solidity_types import ArrayType, ElementaryType, MappingType, UserDefinedType
...
logging.basicConfig()
logger = logging.getLogger("Solscan-read-storage")
...
class SolscanReadStorageException(Exception):
    pass
    ...
    def find_hardcoded_slot_in_fallback(self, contract: Contract) -> Optional[StateVariable]:
        ...
        while len(queue) > 0:
            ...
            if node.type == NodeType.ASSEMBLY and isinstance(node.inline_asm, str):
                return SolscanReadStorage.find_hardcoded_slot_in_asm_str(node.inline_asm, contract)
    ...
    def _find_array_slot(
        ...
        if isinstance(
            ...
            if isinstance(target_variable_type_type, UserDefinedType) and isinstance(
                ...
                info_tmp, type_to, slot, size, offset = SolscanReadStorage._find_struct_var_slot(
