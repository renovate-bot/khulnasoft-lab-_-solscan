...
from solscan.tools.doctor.utils import snip_section
from solscan.utils.colors import red, yellow, green
...
def detect_platform(project: str, **kwargs) -> None:
    ...
    if platform_qty == 0:
        ...
        print(
            red("Please use `--compile-force-framework` in Solscan to force the correct framework.")
        )
    else:
