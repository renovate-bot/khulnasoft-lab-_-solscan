...
class AbstractMutator(metaclass=abc.ABCMeta):  # pylint: disable=too-few-public-methods
    ...
    def __init__(
        self, compilation_unit: SolscanCompilationUnit, rate: int = 10, seed: Optional[int] = None
    ):
        self.compilation_unit = compilation_unit
        self.solscan = compilation_unit.core
        self.seed = seed
        self.rate = rate
    ...
    def mutate(self) -> None:
        ...
        for file in all_patches["patches"]:
            original_txt = self.solscan.source_code[file].encode("utf8")
