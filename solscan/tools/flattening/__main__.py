...
from solscan.tools.flattening.flattening import (
    Flattening,
    Strategy,
    STRATEGIES_NAMES,
    DEFAULT_EXPORT_PATH,
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Contracts flattening. See https://github.com/khulnasoft-lab/solscan/wiki/Contract-Flattening",
        usage="solscan-flat filename",
    )
