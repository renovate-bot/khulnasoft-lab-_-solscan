...
from solscan.core.declarations import SolidityFunction, EnumContract, StructureContract
...
from solscan.core.solidity_types import MappingType, ArrayType
...
from solscan.slithir.operations import NewContract, TypeConversion, SolidityCall, InternalCall
from solscan.tools.flattening.export.export import (
    Export,
    export_as_json,
    save_to_zip,
    save_to_disk,
...
logger = logging.getLogger("Solscan-flat")
...
class Flattening:
    ...
    def __init__(
        ...
        self._compilation_unit: SolscanCompilationUnit = compilation_unit
            ...
            for f in contract.functions_declared:
                ...
                if f.visibility == "external":
                    ...
                    if regex:
                        ...
                        raise SolscanException(f"External keyword not found {f.name} {attributes}")
