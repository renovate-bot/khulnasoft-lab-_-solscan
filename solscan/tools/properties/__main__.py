...
from solscan.tools.properties.properties.erc20 import generate_erc20, ERC20_PROPERTIES
from solscan.tools.properties.addresses.address import (
    Addresses,
    OWNER_ADDRESS,
    USER_ADDRESS,
    ATTACKER_ADDRESS,
...
def main() -> None:
    ...
    contracts = solscan.get_contract_from_name(args.contract)
    if len(contracts) != 1:
        if len(solscan.contracts) == 1:
            contract = solscan.contracts[0]
        else:
