...
from solscan.tools.similarity.info import info
from solscan.tools.similarity.test import test
from solscan.tools.similarity.train import train
from solscan.tools.similarity.plot import plot

logging.basicConfig()
logger = logging.getLogger("Solscan-simil")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Code similarity detection tool. For usage, see https://github.com/khulnasoft-lab/solscan/wiki/Code-Similarity-detector"
    )
