...
simil_logger = logging.getLogger("Solscan-simil")
compiler_logger = logging.getLogger("CryticCompile")
compiler_logger.setLevel(logging.CRITICAL)
solscan_logger = logging.getLogger("Solscan")
solscan_logger.setLevel(logging.CRITICAL)
...
def encode_contract(cfilename, **kwargs):
    ...
    # Init solscan
    try:
        solscan = Solscan(cfilename, **kwargs)
