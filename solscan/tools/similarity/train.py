...
from solscan.tools.similarity.cache import save_cache
from solscan.tools.similarity.encode import encode_contract, load_contracts
from solscan.tools.similarity.model import train_unsupervised
