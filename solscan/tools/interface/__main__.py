...
from solscan.utils.code_generation import generate_interface

logging.basicConfig()
logger = logging.getLogger("Solscan-Interface")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        usage=("solscan-interface <ContractName> <source file or deployment address>"),
    )
...
def main() -> None:
    ...
    _contract = solscan.get_contract_from_name(contract_name)[0]
