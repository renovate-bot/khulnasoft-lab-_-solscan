...
def custom_format(compilation_unit: SolscanCompilationUnit, result):
...
def _patch(
    compilation_unit: SolscanCompilationUnit, result, in_file, modify_loc_start, modify_loc_end
):
