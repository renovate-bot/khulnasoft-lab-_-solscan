...
def custom_format(solscan, result):
...
def _patch(solscan, result, in_file, solc_version, modify_loc_start, modify_loc_end):
    in_file_str = solscan.source_code[in_file].encode("utf8")
