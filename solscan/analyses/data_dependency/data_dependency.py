...
from solscan.slithir.operations import Index, OperationWithLValue, InternalCall, Operation
from solscan.slithir.utils.utils import LVALUE
...
def compute_dependency(compilation_unit: "SolscanCompilationUnit") -> None:
...
def compute_dependency_contract(
    contract: Contract, compilation_unit: "SolscanCompilationUnit"
) -> None:
