...
solscan-interface WETH9 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
DIFF=$(diff crytic-export/interfaces/IWETH9.sol "$DIR_TESTS/test_1.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 1 failed"
...
solscan-interface Mock tests/tools/interface/ContractMock.sol
DIFF=$(diff crytic-export/interfaces/IMock.sol "$DIR_TESTS/test_2.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 2 failed"
...
solscan-interface Mock tests/tools/interface/ContractMock.sol --unroll-structs
DIFF=$(diff crytic-export/interfaces/IMock.sol "$DIR_TESTS/test_3.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 3 failed"
    cat "crytic-export/interfaces/IMock.sol"
    echo ""
...
solscan-interface Mock tests/tools/interface/ContractMock.sol --exclude-structs
DIFF=$(diff crytic-export/interfaces/IMock.sol "$DIR_TESTS/test_4.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 4 failed"
    cat "crytic-export/interfaces/IMock.sol"
    echo ""
...
solscan-interface Mock tests/tools/interface/ContractMock.sol --exclude-errors
DIFF=$(diff crytic-export/interfaces/IMock.sol "$DIR_TESTS/test_5.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 5 failed"
    cat "crytic-export/interfaces/IMock.sol"
    echo ""
...
solscan-interface Mock tests/tools/interface/ContractMock.sol --exclude-enums
DIFF=$(diff crytic-export/interfaces/IMock.sol "$DIR_TESTS/test_6.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 6 failed"
    cat "crytic-export/interfaces/IMock.sol"
    echo ""
...
solscan-interface Mock tests/tools/interface/ContractMock.sol --exclude-events
DIFF=$(diff crytic-export/interfaces/IMock.sol "$DIR_TESTS/test_7.sol" --strip-trailing-cr)
if [  "$DIFF" != "" ]
then
    echo "solscan-interface test 7 failed"
    cat "crytic-export/interfaces/IMock.sol"
    echo ""
